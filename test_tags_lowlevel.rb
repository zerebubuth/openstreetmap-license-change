...
class TestTagsLowlevel < Test::Unit::TestCase
  ...
  def test_create_detection_with_existing
    diff = Tags::Diff.new({'foo' => 'bar'}, {'foo' => 'bar', 'bar' => 'bat'})
  ...
  def test_deletion_with_existing
    diff = Tags::Diff.new({'foo' => 'bar', 'bar' => 'bat'}, {'foo' => 'bar'})
    assert_equal({'foo' => 'bar'}, diff.unchanged)
    assert_equal({}, diff.created)
  ...
  def test_edited
    diff = Tags::Diff.new({'foo' => 'bar'}, {'foo' => 'baz'})
    assert_equal({}, diff.unchanged)
    assert_equal({}, diff.created)
    assert_equal({}, diff.deleted)
  ...
  def test_edited_with_existing
    diff = Tags::Diff.new({'foo' => 'bar', 'bar' => 'bat'}, {'foo' => 'baz', 'bar' => 'bat'})
  ...
  def test_moved
    diff = Tags::Diff.new({'foo' => 'bar'}, {'foop' => 'bar'})
    assert_equal({}, diff.unchanged)
    assert_equal({}, diff.created)
    assert_equal({}, diff.deleted)
    assert_equal({}, diff.edited)
  ...
  def test_moved_with_existing
    diff = Tags::Diff.new({'foo' => 'bar', 'bar' => 'bat'}, {'foop' => 'bar', 'bar' => 'bat'})
    assert_equal({'bar' => 'bat'}, diff.unchanged)
    assert_equal({}, diff.created)
    assert_equal({}, diff.deleted)
    assert_equal({}, diff.edited)
